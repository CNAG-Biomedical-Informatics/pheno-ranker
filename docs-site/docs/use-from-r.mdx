...
<details>
<summary>Example matrix preview</summary>
...
<details>
<summary>Example ranking preview</summary>
...
- For repeated patient matching against a large reference cohort, consider exporting reference data once and using the reuse options described in [Usage](/usage).
