...
<details>
<summary>Is the Web App UI still available?</summary>

The Web App UI is a legacy interface that will be supported until 2027. For new workflows, use the maintained [`pheno-ranker` command-line interface](/usage) locally or through Docker.

The Web App UI is available at [https://pheno-ranker.cnag.eu](https://pheno-ranker.cnag.eu).
