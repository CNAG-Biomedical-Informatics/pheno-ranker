...
A [Web App UI](https://pheno-ranker.cnag.eu), built with [R-Shiny](https://shiny.posit.co), is a legacy interface that will be supported until 2027. The CLI is recommended for new workflows.
...
Use the [Command-Line Interface (CLI)](/usage) for new workflows. The legacy Web App UI remains supported until 2027 for existing workflows.
:::
## Utilities
