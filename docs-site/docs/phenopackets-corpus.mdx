---
title: "Phenopackets Corpus"
slug: "/phenopackets-corpus"
---
...
<details>
<summary>About reproducibility</summary>
...
*/*/PMID_34722527_individual_1797–3128_5_Farzad_Jamshidi_Contributionof.json
*/*/PMID_10939567_EMD1_IV-13.json
*/*/PMID_37761890_50 .json
...
*/*/PMID_33674768_Patient_18_Bögershausen_2016_Hum_Mutat_37_847.json
...
<details>
<summary>Display plot</summary>

<figure>
 <img src={require('@site/static/img/phenopackets-corpus/output_plots.png').default} alt="Output" width="600" />
</figure>
...
:::info[Display plot]
<figure>
 <img src={require('@site/static/img/phenopackets-corpus/mds.png').default} alt="Output" width="600" />
</figure>
:::
:::tip[Large outputs]
...
:::info[Display plot]
<figure>
 <img src={require('@site/static/img/phenopackets-corpus/mds-phenotypicFeatures.png').default} alt="Output" width="600" />
</figure>
:::
...
:::info[Display plot]
<figure>
 <img src={require('@site/static/img/phenopackets-corpus/histogram_with_mean_median.png').default} alt="Output" width="600" />
</figure>
:::
### Colored by Disease
...
:::info[Display plot]
<figure>
 <img src={require('@site/static/img/phenopackets-corpus/mds_color_by_disease.png').default} alt="Output" width="600" />
</figure>
:::
### Graph
...
:::info[Display plot]
<CytoscapeGraph id="cy1" graphPath="/data/corpus_cytoscape.json" limit={50} />
:::
### Converting data to QR-codes

`Pheno-Ranker` allows you to convert your data into [QR-codes](/qr-code-generator).  Let's try an example.
...
2. We use barcode [utilities](/qr-code-generator) to create the codes as `PNG` images:
...
<figure>
 <img src={require('@site/static/img/phenopackets-corpus/phenopackets-corpus-qr.png').default} alt="QR" width="600" />
