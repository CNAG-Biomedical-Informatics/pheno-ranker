...
`bff-pxf-simulator` is a companion command-line utility for generating **simulated** (synthetic) data in either [BFF](/bff) or [PXF](/pxf) formats. 
...
:::info[Potential uses for synthetic data]
...
[View source README](https://raw.githubusercontent.com/CNAG-Biomedical-Informatics/pheno-ranker/main/utils/bff_pxf_simulator/README.md)
