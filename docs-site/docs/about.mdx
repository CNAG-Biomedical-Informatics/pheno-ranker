...
The project brings together phenotype similarity scoring, Beacon v2 and Phenopackets data models, graph export, barcode utilities, and reusable command-line workflows for comparing patient or cohort profiles.
