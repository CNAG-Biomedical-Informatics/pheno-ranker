...
<details>
<summary>Google Colab notebook</summary>
...
<figure>
 MoviePackets logo
 <img src={require('@site/static/img/moviepackets-logo.png').default} alt="MoviePackets" width="300" />
 <figcaption>Image created by ChatGPT4o</figcaption>
</figure>

<details>
<summary>What is a Moviepacket file?</summary>

A Moviepacket is an invented data exchange format :smile: designed for movies. In this tutorial it plays the same role that Phenotype Exchange Format ([PXF](/pxf)) plays for pheno-clinical data: it is simply the input data model. Since it is generic JSON, its `Pheno-Ranker` configuration uses `format: JSON`.
...
<details>
<summary>Do I need to create a configuration file?</summary>

This file only has to be created if you are working with **your own JSON format**. If you have `CSV`, please go to this [page](/csv-import).
...
<Tabs>
<TabItem value="intra-catalog-comparison" label="Intra-catalog comparison">
...
<figure>
  <img src={require('@site/static/img/movies1.png').default} alt="Beacon v2" width="600" />
...
<figure>
  <img src={require('@site/static/img/movies2.png').default} alt="Beacon v2" width="600" />
  <figcaption>Intra-cohort pairwise comparison</figcaption>
</figure>
...
<figure>
   <img src={require('@site/static/img/movies3.png').default} alt="Beacon v2" width="600" />
   <figcaption>Intra-cohort pairwise comparison</figcaption>
</figure>
...
<figure>
  <img src={require('@site/static/img/movies4.png').default} alt="Beacon v2" width="600" />
  <figcaption>Intra-cohort pairwise comparison</figcaption>
</figure>
...
:::info[Directed or undirected graph?]
...
:::
<details>
<summary>See `cytoscape.json`</summary>
...
:::info[Display plot]
<CytoscapeGraph id="cy2" graphPath="/data/movies_cytoscape.json" limit={50} />
:::
<details>
<summary>See `graph_stats.txt`</summary>
...
<TabItem value="inter-catalog-comparison" label="Inter-catalog comparison">
...
:::
<figure>
  <img src={require('@site/static/img/movies5.png').default} alt="Beacon v2" width="600" />
...
<figure>
  <img src={require('@site/static/img/movies6.png').default} alt="Beacon v2" width="600" />
  <figcaption>Inter-catalog multidimensional scaling</figcaption>
</figure>

</TabItem>
<TabItem value="movie-recommendations" label="Movie recommendations">
...
|----|-------------|----------|------|------|--------|----------------|----------------|----------------|----------------------|-------------|---------------|---------------|--------------|-----------|---------|-----------------|---------------|
| 1 | Interstellar | Interstellar | JSON |      7 | False |    0 |  -3.994 |    0.0000325 |  -2.6458 |   1.000 |   4.529 |    0.0002087 |      7 |      7 |      7 |   100.00 |   100.00 |
| 2 | SavingPrivateRyan | Interstellar | JSON |     10 | False |    7 |  -0.846 |    0.1988972 |   1.2649 |   0.300 |   0.438 |    0.7129606 |      6 |      7 |      3 |    42.86 |    50.00 |
| 3 | TheGreenMile | Interstellar | JSON |     11 | False |    8 |  -0.396 |    0.3461273 |   1.5076 |   0.273 |   0.279 |    0.7646809 |      7 |      7 |      3 |    42.86 |    42.86 |
| 4 | Inception | Interstellar | JSON |     11 | False |    8 |  -0.396 |    0.3461273 |   1.5076 |   0.273 |   0.279 |    0.7646809 |      7 |      7 |      3 |    42.86 |    42.86 |
| 5 | TheSilenceoftheLambs | Interstellar | JSON |     11 | False |    8 |  -0.396 |    0.3461273 |   1.5076 |   0.273 |   0.279 |    0.7646809 |      7 |      7 |      3 |    42.86 |    42.86 |
| 6 | TheShawshankRedemption | Interstellar | JSON |     10 | False |    8 |  -0.396 |    0.3461273 |   1.8974 |   0.200 |  -0.146 |    0.8742001 |      5 |      7 |      2 |    28.57 |    40.00 |
| 7 | FightClub | Interstellar | JSON |     10 | False |    8 |  -0.396 |    0.3461273 |   1.8974 |   0.200 |  -0.146 |    0.8742001 |      5 |      7 |      2 |    28.57 |    40.00 |
| 8 | Gladiator | Interstellar | JSON |     11 | False |    8 |  -0.396 |    0.3461273 |   1.5076 |   0.273 |   0.279 |    0.7646809 |      7 |      7 |      3 |    42.86 |    42.86 |
| 9 | Se7en | Interstellar | JSON |     11 | False |    8 |  -0.396 |    0.3461273 |   1.5076 |   0.273 |   0.279 |    0.7646809 |      7 |      7 |      3 |    42.86 |    42.86 |
| 10 | PulpFiction | Interstellar | JSON |     11 | False |    9 |   0.054 |    0.5215214 |   2.1106 |   0.182 |  -0.253 |    0.8948480 |      6 |      7 |      2 |    28.57 |    33.33 |
| 11 | TheMatrix | Interstellar | JSON |     11 | False |    9 |   0.054 |    0.5215214 |   2.1106 |   0.182 |  -0.253 |    0.8948480 |      6 |      7 |      2 |    28.57 |    33.33 |
| 12 | CityofGod | Interstellar | JSON |     11 | False |    9 |   0.054 |    0.5215214 |   2.1106 |   0.182 |  -0.253 |    0.8948480 |      6 |      7 |      2 |    28.57 |    33.33 |
| 13 | TheGodfather | Interstellar | JSON |     11 | False |    9 |   0.054 |    0.5215214 |   2.1106 |   0.182 |  -0.253 |    0.8948480 |      6 |      7 |      2 |    28.57 |    33.33 |
| 14 | ForrestGump | Interstellar | JSON |     11 | False |    9 |   0.054 |    0.5215214 |   2.1106 |   0.182 |  -0.253 |    0.8948480 |      6 |      7 |      2 |    28.57 |    33.33 |
| 15 | TheLordoftheRings:TheFellowshipoftheRing | Interstellar | JSON |     12 | False |   10 |   0.504 |    0.6927786 |   2.3094 |   0.167 |  -0.341 |    0.9100849 |      7 |      7 |      2 |    28.57 |    28.57 |
| 16 | Goodfellas | Interstellar | JSON |     12 | False |   10 |   0.504 |    0.6927786 |   2.3094 |   0.167 |  -0.341 |    0.9100849 |      7 |      7 |      2 |    28.57 |    28.57 |
| 17 | TheDarkKnight | Interstellar | JSON |     12 | False |   10 |   0.504 |    0.6927786 |   2.3094 |   0.167 |  -0.341 |    0.9100849 |      7 |      7 |      2 |    28.57 |    28.57 |
| 18 | StarWars:EpisodeV-TheEmpireStrikesBack | Interstellar | JSON |     12 | False |   10 |   0.504 |    0.6927786 |   2.3094 |   0.167 |  -0.341 |    0.9100849 |      7 |      7 |      2 |    28.57 |    28.57 |
| 19 | Schindler'sList | Interstellar | JSON |     12 | False |   10 |   0.504 |    0.6927786 |   2.3094 |   0.167 |  -0.341 |    0.9100849 |      7 |      7 |      2 |    28.57 |    28.57 |
| 20 | LifeisBeautiful | Interstellar | JSON |     12 | False |   10 |   0.504 |    0.6927786 |   2.3094 |   0.167 |  -0.341 |    0.9100849 |      7 |      7 |      2 |    28.57 |    28.57 |
| 21 | Casablanca | Interstellar | JSON |     12 | False |   10 |   0.504 |    0.6927786 |   2.3094 |   0.167 |  -0.341 |    0.9100849 |      7 |      7 |      2 |    28.57 |    28.57 |
| 22 | SpiritedAway | Interstellar | JSON |     12 | False |   10 |   0.504 |    0.6927786 |   2.3094 |   0.167 |  -0.341 |    0.9100849 |      7 |      7 |      2 |    28.57 |    28.57 |
| 23 | TheLordoftheRings:TheReturnoftheKing | Interstellar | JSON |     12 | False |   10 |   0.504 |    0.6927786 |   2.3094 |   0.167 |  -0.341 |    0.9100849 |      7 |      7 |      2 |    28.57 |    28.57 |
| 24 | ThePianist | Interstellar | JSON |     13 | False |   12 |   1.403 |    0.9197335 |   3.0509 |   0.077 |  -0.866 |    0.9689622 |      7 |      7 |      1 |    14.29 |    14.29 |
| 25 | TheUsualSuspects | Interstellar | JSON |     13 | False |   12 |   1.403 |    0.9197335 |   3.0509 |   0.077 |  -0.866 |    0.9689622 |      7 |      7 |      1 |    14.29 |    14.29 |
...
| RANK | REFERENCE(ID) | TARGET(ID) | FORMAT | LENGTH | WEIGHTED | HAMMING-DISTANCE | DISTANCE-Z-SCORE | DISTANCE-P-VALUE | DISTANCE-Z-SCORE(RAND) | JACCARD-INDEX | JACCARD-Z-SCORE | JACCARD-P-VALUE | REFERENCE-VARS | TARGET-VARS | INTERSECT | INTERSECT-RATE(%) | COMPLETENESS(%) |
|----|-------------|----------|------|------|--------|----------------|----------------|----------------|----------------------|-------------|---------------|---------------|--------------|-----------|---------|-----------------|---------------|
| 1 | NETFLIX_Interstellar | Interstellar | JSON |      4 | False |    0 |  -3.561 |    0.0001845 |  -2.0000 |   1.000 |   4.387 |    0.0003529 |      4 |      4 |      4 |   100.00 |   100.00 |
| 2 | HBO_Interstellar | Interstellar | JSON |      4 | False |    0 |  -3.561 |    0.0001845 |  -2.0000 |   1.000 |   4.387 |    0.0003529 |      4 |      4 |      4 |   100.00 |   100.00 |
| 3 | NETFLIX_Inception | Interstellar | JSON |      6 | False |    4 |  -0.779 |    0.2179810 |   0.8165 |   0.333 |   0.675 |    0.6275454 |      4 |      4 |      2 |    50.00 |    50.00 |
| 4 | NETFLIX_TheShawshankRedemption | Interstellar | JSON |      5 | False |    4 |  -0.779 |    0.2179810 |   1.3416 |   0.200 |  -0.068 |    0.8572146 |      2 |      4 |      1 |    25.00 |    50.00 |
| 5 | NETFLIX_TheLordoftheRings:TheReturnoftheKing | Interstellar | JSON |      6 | False |    4 |  -0.779 |    0.2179810 |   0.8165 |   0.333 |   0.675 |    0.6275454 |      4 |      4 |      2 |    50.00 |    50.00 |
| 6 | HBO_TheLordoftheRings:TheFellowshipoftheRing | Interstellar | JSON |      6 | False |    4 |  -0.779 |    0.2179810 |   0.8165 |   0.333 |   0.675 |    0.6275454 |      4 |      4 |      2 |    50.00 |    50.00 |
| 7 | HBO_Inception | Interstellar | JSON |      6 | False |    4 |  -0.779 |    0.2179810 |   0.8165 |   0.333 |   0.675 |    0.6275454 |      4 |      4 |      2 |    50.00 |    50.00 |
| 8 | HBO_TheLordoftheRings:TheReturnoftheKing | Interstellar | JSON |      6 | False |    4 |  -0.779 |    0.2179810 |   0.8165 |   0.333 |   0.675 |    0.6275454 |      4 |      4 |      2 |    50.00 |    50.00 |
| 9 | NETFLIX_FightClub | Interstellar | JSON |      5 | False |    4 |  -0.779 |    0.2179810 |   1.3416 |   0.200 |  -0.068 |    0.8572146 |      2 |      4 |      1 |    25.00 |    50.00 |
| 10 | HBO_FightClub | Interstellar | JSON |      5 | False |    4 |  -0.779 |    0.2179810 |   1.3416 |   0.200 |  -0.068 |    0.8572146 |      2 |      4 |      1 |    25.00 |    50.00 |
