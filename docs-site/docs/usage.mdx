...
This page summarizes the `pheno-ranker` command-line interface. New users should complete [First Run](/download-and-installation#first-run) before using these examples; see [Download & Installation](/download-and-installation) for Linux, macOS, and Windows guidance.
...
<details>
<summary>Advanced workflows: precomputed references and graph export</summary>
