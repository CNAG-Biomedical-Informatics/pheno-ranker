...
{
# The reference file to compare the output with
my $reference_file = 't/individuals_random_100_ontologies.json';
my $ont_file = 't/ontologies.yaml';
...
# Run the command line script with the input file, and redirect the output to the output_file
system("$script -n 100 -f bff -external-ontologies $ont_file -diseases 1 -max-diseases-pool 1 -phenotypicFeatures 1 -max-phenotypicFeatures-pool 1 -treatments 1 --max-treatments-pool 1 --random-seed 12345 -o $tmp_file");
